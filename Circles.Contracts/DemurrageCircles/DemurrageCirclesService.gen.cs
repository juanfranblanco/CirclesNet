...
using Circles.Contracts.DemurrageCircles.ContractDefinition;

namespace Circles.Contracts.DemurrageCircles
{
    public partial class DemurrageCirclesService: ContractWeb3ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, DemurrageCirclesDeployment demurrageCirclesDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<DemurrageCirclesDeployment>().SendRequestAndWaitForReceiptAsync(demurrageCirclesDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, DemurrageCirclesDeployment demurrageCirclesDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<DemurrageCirclesDeployment>().SendRequestAsync(demurrageCirclesDeployment);
        }

        public static async Task<DemurrageCirclesService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, DemurrageCirclesDeployment demurrageCirclesDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, demurrageCirclesDeployment, cancellationTokenSource);
            return new DemurrageCirclesService(web3, receipt.ContractAddress);
        }

        public DemurrageCirclesService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
        ...
        public Task<BalanceOfOnDayOutputDTO> BalanceOfOnDayQueryAsync(string account, ulong day, BlockParameter blockParameter = null)
        {
        ...
        public Task<DiscountedBalancesOutputDTO> DiscountedBalancesQueryAsync(DiscountedBalancesFunction discountedBalancesFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryDeserializingToObjectAsync<DiscountedBalancesFunction, DiscountedBalancesOutputDTO>(discountedBalancesFunction, blockParameter);
        }

        public Task<DiscountedBalancesOutputDTO> DiscountedBalancesQueryAsync(string returnValue1, BlockParameter blockParameter = null)
        {
            var discountedBalancesFunction = new DiscountedBalancesFunction();
                discountedBalancesFunction.ReturnValue1 = returnValue1;
        ...
        public override List<Type> GetAllFunctionTypes()
        {
            return new List<Type>
            {
                ...
                typeof(DiscountedBalancesFunction),
